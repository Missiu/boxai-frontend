...
const History: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      if (chartId) {
        const chart = initialState?.chartList?.records?.find(
          (chart: any) => String(chart.id) === chartId,
        );
        ...
        <>
          ...
          <Typography>
            <Card>
              ...
              >
                <Text strong>
                  分析名称 : {charInfo?.generationName || selectedChart?.generationName}
                </Text>
              </Paragraph>
              <Paragraph
                style={{ textAlign: 'left' }}
